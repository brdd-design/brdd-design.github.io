const translations = {
  en: {
    ...
    "modules.async.desc": "Asynchronous flow orchestration, distributed state management, and semantic gating.",
    "articles.async_manifesto.title": "BRDD Async: Orchestration",
    "articles.async_manifesto.desc": "How the FlowContext and FlowEngine ensure traceability and consistency in distributed systems.",
  ...
  pt: {
    ...
    "modules.async.title": "BRDD Async",
    "modules.async.desc": "Orquestração de fluxos assíncronos, gestão de estado distribuído e gating semântico.",
    "articles.async_manifesto.title": "BRDD Async: Orquestração",
    "articles.async_manifesto.desc": "Como o FlowContext e a FlowEngine garantem rastreabilidade e consistência em sistemas distribuídos.",
    "modules.bpmn.title": "Async BPMN",
